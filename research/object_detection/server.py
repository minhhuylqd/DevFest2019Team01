...
def result():
	...
	if label == "apple_healthy":
		...
		(Nhổ cỏ thường xuyên xung quanh các cây bệnh để tăng sự tiếp xúc với không khí và ánh sáng. Nhổ bỏ tất cả các cây chết khỏi vườn, vứt chúng vào bao rác để ngăn ngừa sự lây lan) \n
		Although using fungicides is the most effective chemical way, they should be used only when the risk of black rot infection is high, what result in lower numbers of applications during the season and protection of the environment. \n
		(Dù sử dụng thuốc diệt nấm là phương pháp tốt nhất, nhưng chỉ nên sử dụng chúng khi cây nhiễm bệnh thối đen quá nặng, bởi vì thuốc diệt nấm sẽ cho ra năng suất nông sản thấp trong mùa vụ và là để bảo vệ môi trường.) \n
		'''
		...
		Đảo vụ thôi trồng ớt ít nhất 1 năm.\n
		'''
	...
	plant_name = plant_name, disease = disease, treatment_technique = treatment_technique)
